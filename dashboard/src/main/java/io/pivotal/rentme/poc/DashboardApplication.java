...
public class DashboardApplication {
    ...
    public void downloadFile(HttpServletRequest request,
        ...
        ZuulRoute route = zuulProperties.getRoutes().get("data-export-service");
        ...
        HttpEntity<DataExportRequest> entity = new HttpEntity<DataExportRequest>(exportRequest, headers);
        
        String exportContent = restTemplate.postForObject(exportEndpoint, entity, String.class);			
		...
		try {
	        ...
	        //String exampleString = "4V4NC9EH7FN187429,32.4857252827719,-100.19494832724";
	        InputStream inputStream = new ByteArrayInputStream(exportContent.getBytes(StandardCharsets	.UTF_8));
	...
	protected static class ApplicationSecurity extends WebSecurityConfigurerAdapter {
		...
		protected void configure(HttpSecurity http) throws Exception {			
			...
			.and()
			    .headers()./*frameOptions().*/addHeaderWriter(new HeaderWriter() {
					
					@Override
					public void writeHeaders(HttpServletRequest arg0, HttpServletResponse response) {
						response.setHeader("X-Frame-Options", "ALLOWALL");
					}
				})
			.and()
